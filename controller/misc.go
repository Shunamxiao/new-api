...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"theme_preset":                system_setting.GetThemeSettings().Preset,
		"system_name":                 common.SystemName,
		"logo":                        common.Logo,
		"footer_html":                 common.Footer,
		"home_hero_badge":             common.OptionMap["HomeHeroBadge"],
		"home_hero_title":             common.OptionMap["HomeHeroTitle"],
		"home_hero_highlight":         common.OptionMap["HomeHeroHighlight"],
